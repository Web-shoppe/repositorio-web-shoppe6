...
$sql = "SELECT p.*, 
        ...
        LEFT JOIN categorias cat ON cat.id_prod = p.cod_produto
...
<head>
    ...
    <title>Categoria - <?php echo htmlspecialchars($categoria); ?></title>
</head>
<body>
    <?php
    ...
    <hr class="hr-categoria">
    <main>
        <h1 class="h1-cat"><?php echo htmlspecialchars($categoria); ?></h1>
        <div class="div-cat">
                <?php
