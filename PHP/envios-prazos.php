...
<head>
    ...
    <link rel="stylesheet" href="../CSS/envios-prazos.css">
...
<body>
    ...
    <main>
        <h1>Envios e prazos</h1>

        <p>Trabalhamos com fornecedores internacionais dos 
        Estados Unidos, Europa e Ásia, para garantir sempre o 
        melhor preço e a melhor qualidade!</p>

        <p>Nossos fornecedores enviarão seu produto diretamente 
        da fábrica para você.</p>

        <p>O prazo de entrega será entre 10 a 25 dias úteis.</p>

        <p>Se acaso houver atrasos alfandegários e a encomenda 
        ficar retida no Brasil, este prazo até a liberação não 
        conta como prazo de entrega.</p>
